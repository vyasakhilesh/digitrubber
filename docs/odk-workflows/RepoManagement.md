...
1. Add an import statement to your `src/ontology/digitrubber-edit.owl` file. We suggest to do this using a text editor, by simply copying an existing import declaration and renaming it to the new ontology import, for example as follows:
    ```
    ...
    Ontology(<https://www.tib.eu//digitrubber.owl>
    Import(<https://www.tib.eu//digitrubber/imports/ro_import.owl>)
    Import(<https://www.tib.eu//digitrubber/imports/go_import.owl>)
    ...
    ```
...
```
<uri name="https://www.tib.eu//digitrubber/imports/go_import.owl" uri="imports/go_import.owl"/>
```
